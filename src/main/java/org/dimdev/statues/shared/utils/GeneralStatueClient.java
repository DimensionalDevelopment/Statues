package org.dimdev.statues.shared.utils;
...
//		public static EntityDiggingFX addBlockHitEffects(World world, int x, int y, int z, Block blocks, int meta, int side) {
...
//		Minecraft.getMinecraft().world.playSound(x, y, z, soundIn, category, volume, pitch, distanceDelay);(x + 0.5, y + 0.5, z + 0.5, blocks.getSoundType().getStepSound(), 1.0f, 0.6f + 0.4f * rand.nextFloat(), true);
